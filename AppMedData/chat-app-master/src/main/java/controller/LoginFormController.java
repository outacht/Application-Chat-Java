...
public class LoginFormController {
    ...
    public void initialize(){
        // Initialiser le texte du champ de texte
        txtName.setText("Nom & Prénom");
    ...
    public void logInButtonOnAction(ActionEvent actionEvent) throws IOException {
        if (!txtName.getText().isEmpty()&&txtName.getText().matches("[A-Za-z0-9]+")){
            ...
            new Alert(Alert.AlertType.ERROR, "Entrer votre nom (!!Juste des caractère ou des nombres)").show();
        }
    }
}
